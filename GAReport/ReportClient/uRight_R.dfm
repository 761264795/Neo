object RightFrm: TRightFrm
    ...
    object ClientPL: TPanel
      ...
      object TopPl: TPanel
        ...
        object SpeedButton1: TSpeedButton
          ...
          Caption = #20998#37197#26435#38480'(&R)'
          Flat = True
  ...
  object csdUser: TClientDataSet
    Aggregates = <>
    CommandText = 
      'select 1 as img, fnumber,Fname_l2,FID from T_PM_User where fnumb' +
      'er not in ('#39'user'#39','#39'administrator'#39')'
    Params = <>
