...
type
  TFM_BillEditSaleIssueReturn = class(TFM_BillEditBase)
    cxLabel2: TcxLabel;
...
var
  FM_BillEditSaleIssueReturn: TFM_BillEditSaleIssueReturn;

implementation
 uses FrmCliDM,Pub_Fun,uDrpHelperClase,uMaterDataSelectHelper,uPackingListFrm;
{$R *.dfm}
procedure TFM_BillEditSaleIssueReturn.Open_Bill(KeyFields: String; KeyValues: String);
  ...
  begin
    try
      ...
      begin
        ...
        FieldByName('CFSubBillType').AsString := 'SR'; //销售退货
        FieldByName('FTRANSACTIONTYPEID').AsString := 'DawAAAAPoA2wCNyn' ;  //普通销售退货
      end;
    except
      on E : Exception do
      begin
...
function TFM_BillEditSaleIssueReturn.ST_Save : Boolean;
var ErrMsg : string;
   _cds: array[0..1] of TClientDataSet;
   AmountSum : Integer;
begin
...
procedure TFM_BillEditSaleIssueReturn.FormCreate(Sender: TObject);
begin
...
procedure TFM_BillEditSaleIssueReturn.cxbtnNUmberPropertiesChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.btnEnter(Sender: TObject);
begin
  inherited;
   ////
end;

procedure TFM_BillEditSaleIssueReturn.btnExit(Sender: TObject);
begin
  inherited;
   ///
end;

procedure TFM_BillEditSaleIssueReturn.btnKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  ///
...
procedure TFM_BillEditSaleIssueReturn.cxbtnSendWareNumPropertiesChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnReceivWareNumPropertiesChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnReceivOrgNumPropertiesChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cdsDetailNewRecord(DataSet: TDataSet);
begin
  inherited;
  with DataSet do
  begin
    ...
    DataSet.FieldByName('FOrderCustomerID').AsString := cdsMaster.fieldbyname('FCUSTOMERID').AsString;  //送货客户
    DataSet.FieldByName('FBalanceCustomerID').AsString := cdsMaster.fieldbyname('FCUSTOMERID').AsString;  //应收客户
    DataSet.FieldByName('FPaymentCustomerID').AsString := cdsMaster.fieldbyname('FCUSTOMERID').AsString;  //收款客户
...
procedure TFM_BillEditSaleIssueReturn.cdsMasterCalcFields(
  DataSet: TDataSet);
var
  event : TNotifyEvent;
begin
  ...
  try
    ...
    begin
      if FindRecord1(cdsCustomer,'FID',DataSet.fieldbyname('FCUSTOMERID').AsString,1) then
      begin
        cxbtnNUmber.Text := cdsCustomer.fieldbyname('fnumber').AsString;
        DataSet.FindField('CFCustName').AsString := cdsCustomer.fieldbyname('fname_l2').AsString;
      end;
    end;
    if DataSet.FindField('CFBalanceCustName')<> nil then
    begin
      if FindRecord1(cdsCustomer,'FID',DataSet.fieldbyname('FBalanceCustomerID').AsString,1) then
      begin
        cxbtnBalanceCust.Text := cdsCustomer.fieldbyname('fnumber').AsString;
        DataSet.FindField('CFBalanceCustName').AsString := cdsCustomer.fieldbyname('fname_l2').AsString;
      end;
    end;
    ...
    begin
      ...
      begin
        cxbtnOrderCust.Text := cdsCustomer.fieldbyname('fnumber').AsString;
        DataSet.FindField('CFOrderCustName').AsString := cdsCustomer.fieldbyname('fname_l2').AsString;
      end;
    end;
    if DataSet.FindField('CFPayCustName')<> nil then
    begin
      if FindRecord1(cdsCustomer,'FID',DataSet.fieldbyname('FPaymentCustomerID').AsString,1) then
      begin
        cxbtnPayCust.Text := cdsCustomer.fieldbyname('fnumber').AsString;
        DataSet.FindField('CFPayCustName').AsString := cdsCustomer.fieldbyname('fname_l2').AsString;
      end;
    end;    
    if DataSet.FindField('CFSendWareName')<> nil then
    begin
      if FindRecord1(cdswarehouse,'FID',DataSet.fieldbyname('CFWAREHOUSEID').AsString,1) then
      begin
        cxbtnSendWareNum.Text := cdswarehouse.fieldbyname('fnumber').AsString;
        DataSet.FindField('CFSendWareName').AsString := cdswarehouse.fieldbyname('fname_l2').AsString;
      end;
    end;
    if DataSet.FindField('CFReceivWareName')<> nil then
    begin
      if FindRecord1(cdswarehouse,'FID',DataSet.fieldbyname('CFINWAREHOUSEID').AsString,1) then
      begin
        cxbtnReceivWareNum.Text := cdswarehouse.fieldbyname('fnumber').AsString;
        DataSet.FindField('CFReceivWareName').AsString := cdswarehouse.fieldbyname('fname_l2').AsString;
      end;
    end;
    if DataSet.FindField('CFReceivOrgName')<> nil then
    begin
      if FindRecord1(cdsBranch,'FID',DataSet.fieldbyname('CFRECEIVESTOREUNIT').AsString,1) then
      begin
        cxbtnReceivOrgNum.Text := cdsBranch.fieldbyname('fnumber').AsString;
        DataSet.FindField('CFReceivOrgName').AsString := cdsBranch.fieldbyname('fname_l2').AsString;
      end;
    end;
  finally
    if tmpbtnEdit<> nil then
...
procedure TFM_BillEditSaleIssueReturn.FormShow(Sender: TObject);
begin
  inherited;
  sIniBillFlag :='CS';
...
procedure TFM_BillEditSaleIssueReturn.dbgList2Editing(
...
procedure TFM_BillEditSaleIssueReturn.cdsDetailAmountFTaxRateChange(
  Sender: TField);
var
...
procedure TFM_BillEditSaleIssueReturn.dbgList2CFLocationNamePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.dbgList2FISPRESENTPropertiesChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.girdListKeyDown(Sender: TObject;
...
procedure TFM_BillEditSaleIssueReturn.girdListDblClick(Sender: TObject);
begin
  inherited;
  if tmpbtnEdit <> nil then
...
procedure TFM_BillEditSaleIssueReturn.cxPageDetailChange(Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cdsDetailAmountFActualTaxPriceChange(
  Sender: TField);
    var
    Event,EventRate : TFieldNotifyEvent;
begin
...
procedure TFM_BillEditSaleIssueReturn.cdsDetailAmountFACTUALPRICEChange(
  Sender: TField);
  var
    Event,EventRate : TFieldNotifyEvent;
begin
...
procedure TFM_BillEditSaleIssueReturn.cxbtnNUmberPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
  var
...
begin
  ...
  try
    ...
    with Select_BaseData('t_Bd_Customer','客户','','') do
    begin
      if not IsEmpty then
      begin
...
procedure TFM_BillEditSaleIssueReturn.cxbtnSendWareNumPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
  var
    ChangEvent : TNotifyEvent;
begin
...
procedure TFM_BillEditSaleIssueReturn.cxbtnReceivWareNumPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
  var
    ChangEvent : TNotifyEvent;
begin
...
procedure TFM_BillEditSaleIssueReturn.cxbtnReceivOrgNumPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
  var
    ChangEvent : TNotifyEvent;
begin
...
procedure TFM_BillEditSaleIssueReturn.calAmt(DataSet: TDataSet);//计算金额
begin
...
procedure TFM_BillEditSaleIssueReturn.cdsDetailFQTYChange(Sender: TField);
begin
  inherited;
  ...
  Sender.DataSet.FieldByName('FUnInQty').AsFloat := Abs(Sender.DataSet.fieldbyname('Fqty').AsFloat);
  Sender.DataSet.FieldByName('FUnInBaseQty').AsFloat :=  Abs(Sender.DataSet.fieldbyname('Fqty').AsFloat);
  Sender.DataSet.FieldByName('FASSOCIATEQTY').AsFloat := Abs(Sender.DataSet.fieldbyname('Fqty').AsFloat);
end;

procedure TFM_BillEditSaleIssueReturn.cdsMasterFCUSTOMERIDChange(
  Sender: TField);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cdsMasterBeforePost(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnBalanceCustPropertiesChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnOrderCustPropertiesChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnPayCustPropertiesChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnBalanceCustPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  if not  cdsMaster.Active then Exit;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnOrderCustPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  if not  cdsMaster.Active then Exit;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnPayCustPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  if not  cdsMaster.Active then Exit;
...
procedure TFM_BillEditSaleIssueReturn.cdsCustomerFilterRecord(
...
procedure TFM_BillEditSaleIssueReturn.cdsMasterCFRECEIVESTOREUNITChange(
  Sender: TField);
var
...
begin
  inherited;
  try
    strSql :=' select FID,Fnumber,Fname_l2,FhelpCode,fhaslocation,CFCustomerID,fstorageorgid from t_Db_Warehouse where FWhState=1 and fstorageorgid='+quotedstr(Sender.AsString);
...
procedure TFM_BillEditSaleIssueReturn.cdsInWarehouseFilterRecord(
  DataSet: TDataSet; var Accept: Boolean);
begin
  inherited;
  if tmpbtnEdit<> nil then
...
procedure TFM_BillEditSaleIssueReturn.dbgList2cfMaterialNumberPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  FindMaterial;
...
procedure TFM_BillEditSaleIssueReturn.dbgList2CFColorCodePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  FindColor;
...
procedure TFM_BillEditSaleIssueReturn.dbgList2CFCupNamePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  FindCup;
...
procedure TFM_BillEditSaleIssueReturn.dbgList2CFPackNamePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  FindPack;
...
procedure TFM_BillEditSaleIssueReturn.cdsDetailAmountFMATERIALIDChange(
  Sender: TField);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cdsDetailAmountFDISCOUNTRATEChange(
  Sender: TField);
  var
...
procedure TFM_BillEditSaleIssueReturn.cdsDetailBeforePost(
  DataSet: TDataSet);
begin
  inherited;
  DataSet.FieldByName('FWAREHOUSEID').AsString := cdsMaster.fieldbyname('CFWAREHOUSEID').AsString; //发货仓库
...
procedure TFM_BillEditSaleIssueReturn.cdsDetailAmountCFPACKIDChange(
  Sender: TField);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cdsDetailAmountCFPACKNUMChange(
  Sender: TField);
begin
  inherited;
  if cdsDetailAmount.FieldByName('CFPackNum').AsInteger>0 then
...
procedure TFM_BillEditSaleIssueReturn.btn_PackingListClick(
  Sender: TObject);
...
procedure TFM_BillEditSaleIssueReturn.cdsMasterCFWAREHOUSEIDChange(
  Sender: TField);
begin
  inherited;
  FOutWarehouseFID := cdsMaster.fieldbyname('CFWAREHOUSEID').AsString;
...
procedure TFM_BillEditSaleIssueReturn.cdsMasterCFINWAREHOUSEIDChange(
  Sender: TField);
begin
  inherited;
  FInWarehouseFID := cdsMaster.fieldbyname('CFINWAREHOUSEID').AsString;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnSendWareNumKeyPress(
...
procedure TFM_BillEditSaleIssueReturn.cxbtnReceivWareNumKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnNUmberKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnReceivOrgNumKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnBalanceCustKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnOrderCustKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TFM_BillEditSaleIssueReturn.cxbtnPayCustKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  DelBtnEditValue(Key,'FPaymentCustomerID');
end;
procedure TFM_BillEditSaleIssueReturn.AddDetailRecord;
var
