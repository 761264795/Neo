...
uses
  ...
  cxTextEdit, jpeg, ExtCtrls, Grids, DBGrids, ActnList, cxSpinEdit,
  cxRichEdit, dxSkinsCore, dxSkinOffice2007Black, dxSkinOffice2007Blue,
  dxSkinOffice2007Green, dxSkinOffice2007Pink, dxSkinOffice2007Silver,
  dxSkinscxPCPainter;

type
  TFrm_AcrossInput_Base = class(TSTBaseEdit)
    Panel1: TPanel;
    Image1: TImage;
    Label1: TLabel;
    ...
    procedure dbgMulti1EditKeyDown(Sender: TcxCustomGridTableView;
      AItem: TcxCustomGridTableItem; AEdit: TcxCustomEdit; var Key: Word;
      Shift: TShiftState);
  private
...
var
  Frm_AcrossInput_Base: TFrm_AcrossInput_Base;
...
procedure TFrm_AcrossInput_Base.btCloseClick(Sender: TObject);
begin
  inherited;
  Close;
end;

procedure TFrm_AcrossInput_Base.SetMasterSizesGroup(fMaterialID: string;
...
procedure TFrm_AcrossInput_Base.cdsDetailAmountCalcFields(DataSet: TDataSet);
...
procedure TFrm_AcrossInput_Base.SetAcrossInput(Material_FID: string;cdsDetail:TClientDataSet);
...
procedure TFrm_AcrossInput_Base.edtStyleCodeKeyDown(Sender: TObject;
...
procedure TFrm_AcrossInput_Base.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 // inherited;
...
procedure TFrm_AcrossInput_Base.FormShow(Sender: TObject);
begin
//  inherited;
...
procedure TFrm_AcrossInput_Base.edtStyleCodePropertiesChange(Sender: TObject);
...
procedure TFrm_AcrossInput_Base.bgMaterKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
//编辑状态左右键处理
procedure TFrm_AcrossInput_Base.dbgMulti1EditKeyUp(
...
procedure TFrm_AcrossInput_Base.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFrm_AcrossInput_Base.actStyleCheckExecute(Sender: TObject);
var Material_FID : string;
begin
  inherited;
  Material_FID := qryMaterial.fieldbyName('FID').AsString;
...
procedure TFrm_AcrossInput_Base.dbgMulti1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if (Key=38) then  //向上
...
procedure TFrm_AcrossInput_Base.bgMaterCellClick(Column: TColumn);
begin
  inherited;
  if qryMaterial.IsEmpty then exit;
  actStyleCheck.Execute;
...
procedure TFrm_AcrossInput_Base.actF5SaveExecute(Sender: TObject);
...
procedure TFrm_AcrossInput_Base.btInWarehousePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  GetWareHouse;
end;

procedure TFrm_AcrossInput_Base.GetWareHouse;
...
procedure TFrm_AcrossInput_Base.SetMaterialInfo(MaterialFID: string);
var Material_FID : string;
begin
  inherited;
  Material_FID := qryMaterial.fieldbyName('FID').AsString;
...
procedure TFrm_AcrossInput_Base.btSaveClick(Sender: TObject);
begin
  inherited;
  actF5Save.Execute;
  lbSaveState.Caption := '保存数据完成，可以继续录入其他商品数据！';
...
procedure TFrm_AcrossInput_Base.btInWarehouseKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  inherited;
  if (Key=40) then   //向下键
...
procedure TFrm_AcrossInput_Base.edtStyleCodePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
...
procedure TFrm_AcrossInput_Base.CreateParams(var Params: TCreateParams);
begin
...
procedure TFrm_AcrossInput_Base.dbgMulti1EditKeyPress(
  Sender: TcxCustomGridTableView; AItem: TcxCustomGridTableItem;
...
procedure TFrm_AcrossInput_Base.dbgMulti1EditKeyDown(
  Sender: TcxCustomGridTableView; AItem: TcxCustomGridTableItem;
  AEdit: TcxCustomEdit; var Key: Word; Shift: TShiftState);
begin
  inherited;
  //  ShowMessage('dbgMulti1EditKeyDown'+IntToStr(Key));
end;
