...
type
  TFM_BillEditPurInWarehs = class(TFM_BillEditBase)
...
var
  FM_BillEditPurInWarehs: TFM_BillEditPurInWarehs;
  function EditFillPurInWarehs_Frm(KeyValues : string):Boolean;

  
implementation
uses FrmCliDM,Pub_Fun,uTSView,uMaterDataSelectHelper;
{$R *.dfm}
...
procedure TFM_BillEditPurInWarehs.Open_Bill(KeyFields, KeyValues: String);
...
begin
  ...
  begin
    ...
    begin
      ...
      FieldByName('Cfmaterialtype').AsString := 'QI'; ///渠道采购入库
...
function TFM_BillEditPurInWarehs.ST_Save: Boolean;
var ErrMsg : string;
   _cds: array[0..1] of TClientDataSet;
   AmountSum : Integer;
begin
...
procedure TFM_BillEditPurInWarehs.FormCreate(Sender: TObject);
var
  strError : string;
  strsql : string  ;
  orderTypesql : string;
...
begin
  ...
  dxBarCodeSM.Enabled := False;

  cdsSupplier.Data := CliDM.cdsSupplier.Data; //供应商
  cdswarehouse.Data := CliDM.cdsWarehouse.Data;//仓库
end;

procedure TFM_BillEditPurInWarehs.FormDestroy(Sender: TObject);
begin
  inherited;
  FM_BillEditPurInWarehs := nil;
end;

procedure TFM_BillEditPurInWarehs.cdsDetailNewRecord(DataSet: TDataSet);
begin
  inherited;
  with DataSet do
  begin
    ...
    DataSet.FieldByName('FWAREHOUSEID').AsString := cdsMaster.fieldbyname('CFINWAREHOUSEID').AsString; //仓库
  end;
end;

procedure TFM_BillEditPurInWarehs.dbgList2cfMaterialNumberPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  FindMaterial; //弹选商品
...
procedure TFM_BillEditPurInWarehs.dbgList2CFColorNamePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  FindColor;  //弹选颜色
...
procedure TFM_BillEditPurInWarehs.dbgList2CFCupNamePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
   FindCup; //弹选内长
...
procedure TFM_BillEditPurInWarehs.dbgList2Column1PropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  FindPack;
...
procedure TFM_BillEditPurInWarehs.cdsDetailAmountCFPACKNUMChange(
  Sender: TField);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.actSetBillStatusExecute(Sender: TObject);
begin
 // inherited;
...
procedure TFM_BillEditPurInWarehs.pmDetailPopup(Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.bbtCheckClick(Sender: TObject);
begin
  if trim(cdsMaster.FieldByName('CFINPUTWAY').AsString) ='PACK' then
  begin
...
procedure TFM_BillEditPurInWarehs.updateQtyClick(Sender: TObject);
begin
...
procedure TFM_BillEditPurInWarehs.actAuditExecute(Sender: TObject);
begin
...
procedure TFM_BillEditPurInWarehs.btn_TsCiewClick(Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.cxbtnNUmberPropertiesChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.cxbtnReceivWareNumPropertiesChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.cdsMasterCalcFields(DataSet: TDataSet);
var
  event : TNotifyEvent;
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.FormShow(Sender: TObject);
begin
  inherited;
  sIniBillFlag :='PI';
  sSPPack := 'SCM';
...
procedure TFM_BillEditPurInWarehs.cdsDetailBeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.calAmt(DataSet: TDataSet);
begin
...
procedure TFM_BillEditPurInWarehs.cxbtnNUmberPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
  var
...
procedure TFM_BillEditPurInWarehs.cxbtnReceivWareNumPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
  var
    ChangEvent : TNotifyEvent;
begin
...
procedure TFM_BillEditPurInWarehs.cdsMasterFSUPPLIERIDChange(
  Sender: TField);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.cdsDetailAmountAfterInsert(
  DataSet: TDataSet);
begin
  inherited;
  strMatID := '';
...
procedure TFM_BillEditPurInWarehs.dbgList2Editing(
...
procedure TFM_BillEditPurInWarehs.girdListDblClick(Sender: TObject);
begin
  inherited;
  if tmpbtnEdit <> nil then
...
procedure TFM_BillEditPurInWarehs.girdListKeyDown(Sender: TObject;
...
procedure TFM_BillEditPurInWarehs.cxPageDetailChange(Sender: TObject);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.cdsDetailAmountFACTUALTAXPRICEChange(
  Sender: TField);
  var
...
procedure TFM_BillEditPurInWarehs.cdsDetailAmountFACTUALPRICEChange(
  Sender: TField);
  var
    Event,EventRate : TFieldNotifyEvent;
begin
...
procedure TFM_BillEditPurInWarehs.cdsDetailFQTYChange(Sender: TField);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.cdsSupplierFilterRecord(
...
procedure TFM_BillEditPurInWarehs.cdswarehouseFilterRecord(
  DataSet: TDataSet; var Accept: Boolean);
begin
  inherited;
  if tmpbtnEdit<> nil then
...
procedure TFM_BillEditPurInWarehs.cdsDetailAmountFDISCOUNTRATEChange(
  Sender: TField);
 var
...
procedure TFM_BillEditPurInWarehs.dbgList2CFLocNamePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.cdsDetailAmountBeforePost(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.cdsDetailAmountCalcFields(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TFM_BillEditPurInWarehs.cdsDetailAmountCFPACKIDChange(
  Sender: TField);
begin
  inherited;
  if cdsDetailAmount.FieldByName('CFPackNum').AsInteger>0 then
...
procedure TFM_BillEditPurInWarehs.cdsDetailAmountFTAXRATEChange(
  Sender: TField);
  var
    Event,EventRate : TFieldNotifyEvent;
begin
...
procedure TFM_BillEditPurInWarehs.AddDetailRecord;
var
...
procedure TFM_BillEditPurInWarehs.cdsDetailAmountAfterPost(
  DataSet: TDataSet);
begin
  inherited;
  ///
...
procedure TFM_BillEditPurInWarehs.cdsDetailAmountBeforeEdit(
  DataSet: TDataSet);
begin
  inherited;
