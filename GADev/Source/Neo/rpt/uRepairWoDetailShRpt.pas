...
type
  TRepairWoDetailShRpt = class(TFM_ReportListBase)
...
var
  RepairWoDetailShRpt: TRepairWoDetailShRpt;

implementation

{$R *.dfm}

procedure TRepairWoDetailShRpt.FormCreate(Sender: TObject);
begin
  Self.FBillTypeFID := 'CAA04B5868B44B059FD519BD05347D6C';
  inherited;
